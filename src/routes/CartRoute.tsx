...
export default function CartRoute() {
    ...
    return (
        <div className="mx-auto pt-24 px-6 pb-28 min-h-screen lg:max-w-screen-xl">
                    ...
                    <div className="flex flex-col gap-6 sm:gap-10 mt-8 sm:mt-10">
                        {
                            cartitems?.map((item, index) => {
                                ...
                                return <div
                                    key={`cartItem-${index}`}
                                    className="flex justify-between items-stretch gap-5 sm:gap-10 lg:gap-20 card-gradient p-3 rounded-xl shadow-lg transition-all duration-300 hover:scale-105"
                                >
                                    <img
                                        src={product?.mainImg}
                                        alt={product?.heading}
                                        className="h-16 w-16 sm:h-20 sm:w-20 object-contain rounded-md bg-white p-2 cursor-pointer"
